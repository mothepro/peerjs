...
declare namespace PeerJs{
    ...
    export interface Peer{
         ...
         */
        connect(id: peerID, options?: PeerJs.PeerConnectOption): PeerJs.DataConnection;
        /**
         ...
         */
        call(id: peerID, stream: any, options?: any): PeerJs.MediaConnection;
        /**
         ...
         * @param id
         */
        getConnection(peer: Peer, id: dcID): any;
